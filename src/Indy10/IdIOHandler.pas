...
//TODO:
  ...
  public
    ...
    function ReadInteger(AConvert: Boolean=true): LongInt;
    //
    // Read___
...
function TIdIOHandler.ReadInteger(AConvert: Boolean): LongInt;
begin
  result:=readLongInt(aConvert);
end;

function TIdIOHandler.ReadCardinal(AConvert: Boolean=true): cardinal;
begin
  result:=readLongWord(aConvert);
end;
      ...
      try
        try
          ...
          on E: Exception do begin
            ...
            if (E is EIdConnClosedGracefully) (*and (IgnoreGracefullyErrs or AReadUntilDisconnect) *)  then begin
              Break;
            end else begin
              raise;
            end;
